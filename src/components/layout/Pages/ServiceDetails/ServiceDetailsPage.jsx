  ...
  <>
   ...
   <TopPaddingSection>
    <SideMarginTemp>
     <CageBoxTemp>
      <BoxTemp
       customStyle={"mt-[48px] w-[390.4px] md:w-[720px] lg:w-[439.987px]"}>
       {/* services list */}
      ...
      <BoxTemp
       customStyle={
        " w-[390.4px] md:w-[720px] lg:w-[879.987px] mt-[48px] lg:pl-[48px] lg:pr-[12px] "
       }>
       <img
        src="https://bootstrapmade.com/demo/templates/Gp/assets/img/services.jpg"
        alt="office image"
        className=" h-[231.863px] md:h-[440.438px] lg:h-[518.888px] mb-[20px] overflow-clip max-w-full "
       />
